                                        ; A copy of dracula-theme with some changes inspired by https://tonsky.me/blog/syntax-highlighting/
...
(defgroup nosferatu nil
  "Dracula theme options.

The theme has to be reloaded after changing anything in this group."
  :group 'faces)

(defcustom nosferatu-enlarge-headings t
  "Use different font sizes for some headings and titles."
  :type 'boolean
  :group 'nosferatu)

(defcustom nosferatu-height-title-1 1.3
  "Font size 130%."
  :type 'number
  :group 'nosferatu)

(defcustom nosferatu-height-title-2 1.1
  "Font size 110%."
  :type 'number
  :group 'nosferatu)

(defcustom nosferatu-height-title-3 1.0
  "Font size 100%."
  :type 'number
  :group 'nosferatu)

(defcustom nosferatu-height-doc-title 1.44
  "Font size 144%."
  :type 'number
  :group 'nosferatu)

(defcustom nosferatu-alternate-mode-line-and-minibuffer nil
  "Use less bold and pink in the minibuffer."
  :type 'boolean
  :group 'nosferatu)

(defvar nosferatu-use-24-bit-colors-on-256-colors-terms nil
...
(let ((colors '(;; Upstream theme color
      ...
      (faces '(;; default / basic faces
               ...
               (font-lock-comment-face :foreground ,dracula-orange :weight bold)
               (font-lock-comment-delimiter-face :inherit shadow)
               (font-lock-constant-face :foreground ,dracula-pink)
               (font-lock-doc-face :foreground ,dracula-pink)
               ...
               (font-lock-number-face :foreground ,dracula-yellow)
               ...
               (font-lock-type-face :inherit font-lock-builtin-face :weight bold)
               (font-lock-variable-name-face :foreground ,dracula-purple :weight bold)
             ...
             (push `(,face
                     ((((min-colors 16777216)) ; fully graphical envs
                      ...
                      (((min-colors 256))      ; terminal withs 256 colors
                       ,(if nosferatu-use-24-bit-colors-on-256-colors-terms
                            (funcall expand-with-func 'cadr spec)
